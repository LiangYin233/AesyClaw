    ...
    >
      ...
      <div class="flex items-center h-16 px-4 border-b border-gray-700">
        <div class="flex items-center gap-3">
          ...
          <span v-if="!collapsed" class="font-bold text-lg">AesyClaw</span>
        </div>
      </div>
        ...
        <ul class="space-y-1 px-2">
          <li v-for="item in navItems" :key="item.path">
            ...
            >
              ...
              <svg v-else-if="item.icon === 'terminal'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="p-4 border-t border-gray-700">
        <button
          @click="handleLogout"
          class="flex items-center gap-3 w-full px-3 py-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg transition-colors"
        >
