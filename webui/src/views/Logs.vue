    ...
    <div class="mx-auto max-w-[1680px]">
      ...
      <div class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_22rem]">
        <section class="hairline-card overflow-hidden rounded-[1.6rem]">
          ...
          <div v-if="loading" class="flex min-h-[20rem] items-center justify-center px-5 text-center text-sm text-on-surface-variant">正在拉取日志数据...</div>
          ...
          <div v-else class="flex min-h-[20rem] items-center justify-center px-5 text-center">
            <div>
