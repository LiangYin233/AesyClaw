    ...
    <div v-else class="flex flex-col gap-5">
        ...
        >
          ...
          >
            ...
            <div
              ...
              :key="model.key"
              class="overflow-hidden border border-[var(--color-border)] rounded bg-[rgba(250,249,245,0.75)] shadow-sm"
            >
              <div
                class="flex items-start justify-between gap-4 px-4 py-3 border-b border-[var(--color-border)] bg-[rgba(255,255,255,0.45)]"
              >
                <div class="min-w-0">
                  <div class="font-heading text-sm font-semibold text-dark truncate">
                    {{ model.key || 'New model' }}
                  </div>
                  <div class="font-body text-xs text-mid-gray mt-1">Model preset</div>
                </div>
              ...
              <div class="p-4">
                ...
                <div class="border-t border-dashed border-[var(--color-border)] pt-3">
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span
                      ...
                      :class="{ 'rotate-90': isAdvancedBodyOpen(provider.key, model.key) }"
                      >›</span
                    >
                  </button>
                  <div v-if="isAdvancedBodyOpen(provider.key, model.key)" class="mt-4">
                    <JsonEditor
      ...
      <section class="min-w-0 flex flex-col gap-4">
        ...
        <div
          ...
          class="overflow-hidden border border-[var(--color-border)] rounded bg-surface shadow-sm"
        >
          <div
            class="flex items-start justify-between gap-4 px-4 py-3 border-b border-[var(--color-border)] bg-[rgba(255,255,255,0.45)]"
          >
            ...
            <button
              type="button"
              class="inline-flex items-center justify-center p-1.5 border border-transparent rounded-sm cursor-pointer transition-all duration-[0.15s] ease bg-[#CF3A3A] text-white hover:bg-[#b83333] disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
          ...
          <div class="p-4">
            ...
            <div v-if="server.transport === 'stdio'" class="mb-5">
              <label
                class="block mb-[0.4rem] font-heading font-medium text-xs text-dark tracking-[0.02em] uppercase"
                >Command</label
              >
