...
export function omitTopLevelConfigKeys(
  source: unknown,
...
export function omitTopLevelSchemaProperties(
  source: unknown,
...
export function getSchemaProperties(schema: JsonSchemaRecord): Record<string, unknown> {
