...
import type { CommandRegistry } from '../legacy-commands/index.js';
import type { SessionMemoryService } from '../legacy-memory/SessionMemoryService.js';
import type { SessionRoutingService } from '../legacy-session/SessionRoutingService.js';
import type { AgentRoleService } from '../legacy-roles/AgentRoleService.js';
import type { VisionSettings } from '../../types.js';
import { logger } from '../../observability/index.js';
import { AgentPipeline } from './AgentPipeline.js';
import { SessionResolver } from '../legacy-session/SessionResolver.js';
import { BackgroundTaskManager } from '../legacy-execution/BackgroundTaskManager.js';
import { ExecutionEngine } from '../legacy-execution/ExecutionEngine.js';
import { ExecutionRuntime } from '../legacy-execution/ExecutionRuntime.js';
import { ExecutionRegistry } from '../legacy-execution/ExecutionRegistry.js';
import type { ExecutionStatus, SessionReference } from '../legacy-types.js';
