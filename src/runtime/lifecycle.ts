...
import { DEFAULT_CONFIG } from '@aesyclaw/core/config/defaults';
...
/** 运行时生命周期管理器 — 协调所有子系统的启动与关闭顺序 */
export class RuntimeLifecycle {
  private readonly deps: RuntimeLifecycleDependencies;
  private extensionManager: ExtensionManager | null = null;
  private webUiManager: WebUiManager | null = null;
  private cronManager: CronManager | null = null;
  private shuttingDown = false;

  constructor(deps: RuntimeLifecycleDependencies) {
    this.deps = deps;
  }

  private get resolvedDeps(): RuntimeLifecycleDependencies {
    return this.deps;
  }
